...
description: Define, source, evaluate, and score "full-loop" growth operators based on loop ownership, business-model fit, and execution traits — replacing functional hiring with capability-based hiring.
---
...
**Core principle:** Hire for sector/business model expertise + meta-skills, not functional expertise. A growth operator who deeply understands B2B SaaS subscription dynamics will outperform a "growth expert" who's only worked in e-commerce. Prioritize business-model fit and loop ownership over generic growth credentials.

## When To Use

- Defining a new growth role
- Creating a hiring scorecard
- Evaluating candidates for product, growth, or lifecycle ownership
- Aligning a hiring team on what "good" looks like
...
Tailor outreach around loop ownership, business-model relevance, and operator credibility.
...
Save a hiring plan or scorecard to `{brain}/ops/hiring/growth-operator-hiring-plan.md`.

Recommended sections:

1. Role definition
2. Must-have and anti-signals
3. Sourcing plan
4. Screening rubric
5. Work sample
...
- Behavioral evidence over buzzwords
- Specific ownership over channel familiarity
- Clear pass/fail logic over vague fit language

## Adaptation Notes

- This workflow works well in ChatGPT Projects because teams can share scorecards and transcripts.
- In Codex or other file-centric surfaces, keep scorecards and candidate notes as local artifacts.
