---
name: ads-microsoft
description: Audit Microsoft Ads and Bing campaigns across search, Performance Max, Audience Network, and Copilot integration — 20 checks with attention to Google import validation, UET, syndication, LinkedIn profile targeting, unique Microsoft features, and cost advantage versus Google.
---

# Microsoft Ads — Deep Analysis (Search, PMax, Copilot, Import)
...
Triggers on: "Microsoft Ads", "Bing Ads", "Bing PPC", "Copilot ads", "Microsoft campaign".

---

## When To Use

- Running a Microsoft/Bing Ads platform deep dive (routed from the `ads` skill or invoked directly)
- Validating a Google Ads import into Microsoft Ads
- Assessing Copilot placement readiness and Microsoft-unique feature adoption
- Quantifying the Microsoft cost advantage (CPC/CVR) versus Google

## Input / Output Contract

**Inputs:**

- microsoft_ads_export
- uet_status
...
- Microsoft Ads audit report: `{brain}/ads/platforms/microsoft-ads-audit-{date}.md`

## Process

1. Collect Microsoft Ads data (account export, UET tag status, import results)
2. Read `tools/ads-references/microsoft-audit.md` for full 20-check audit
3. Read `tools/ads-references/benchmarks.md` for Microsoft-specific benchmarks
...
Save the audit report to `{brain}/ads/platforms/microsoft-ads-audit-{date}.md`
(example: a legacy standalone run may emit this as `MICROSOFT-ADS-REPORT.md` in the working directory).
...
- Do not assume Google imports are correct.
- CPC advantage should be judged alongside conversion quality.
- Highlight unique Microsoft features worth testing.

## Adaptation Notes

- Use `tools/ads-references/microsoft-audit.md` for full checks.
