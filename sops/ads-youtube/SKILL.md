---
name: ads-youtube
description: YouTube Ads specific analysis covering campaign types, creative quality, audience targeting, and measurement — evaluates video ad performance across skippable, non-skippable, bumper, Shorts, and Demand Gen formats, plus platform-specific video requirements.
---
...
1. Collect YouTube Ads data (Google Ads export filtered to Video campaigns, video assets, audience setup, placement context, and performance data)
2. Read `tools/ads-references/google-audit.md` for YouTube-relevant checks
3. Read `tools/ads-references/platform-specs.md` for video specifications
4. Read `tools/ads-references/benchmarks.md` for YouTube benchmarks
...
Weighted assessment from `tools/ads-references/scoring-system.md`:
...
Save to `{brain}/ads/platforms/youtube-ads-audit-{date}.md`.

### Deliverables
- `{brain}/ads/platforms/youtube-ads-audit-{date}.md` — Campaign-by-campaign analysis (example: `YOUTUBE-ADS-REPORT.md` in a standalone engagement)
...
- Creative assessment should account for campaign type and placement.
- Shorts and horizontal video should not be evaluated by the same assumptions.
- Recommendations should separate brand lift goals from conversion goals.

## Adaptation Notes

- YouTube audits can reference Google Ads data plus video asset review.
